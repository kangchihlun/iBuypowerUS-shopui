...
export function ShopList() {
    ...
    const shopItemProps: ShopItemParams[] = displayedItems.map((product) => ({
        prod: product,
        ...
        <>
            <div className="flex h-12 justify-end items-center px-4 mb-0">
                <div className="flex items-center h-6 rounded-sm cursor-pointer">
                    <button onClick={() => handlePageChange('left')} className="w-10 h-10 bg-white border-3 font-bold text-black shadow-md rounded-sm opacity-100"> &lt; </button>
